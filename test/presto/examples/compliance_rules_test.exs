defmodule Presto.Examples.ComplianceRulesTest do
  ...
  describe "weekly aggregation rule" do
    test "aggregates time entries into weekly totals" do
      ...
      time_entries = [
        Factories.build_processed_time_entry("entry_1", 
          DateTime.new!(monday, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(monday, ~T[17:00:00], "Etc/UTC"), "emp_001"),
        Factories.build_processed_time_entry("entry_2",
          DateTime.new!(Date.add(monday, 1), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 1), ~T[17:00:00], "Etc/UTC"), "emp_001"),
        Factories.build_processed_time_entry("entry_3",
          DateTime.new!(Date.add(monday, 2), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 2), ~T[17:00:00], "Etc/UTC"), "emp_001")
      ]
      ...
      assert week_end == Date.add(monday, 6) # Sunday
    end
    ...
    test "groups entries by employee and week correctly" do
      ...
      time_entries = [
        # Employee 1, Week 1
        Factories.build_processed_time_entry("e1_w1_1",
          DateTime.new!(monday, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(monday, ~T[17:00:00], "Etc/UTC"), "emp_001"),
        Factories.build_processed_time_entry("e1_w1_2",
          DateTime.new!(Date.add(monday, 1), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 1), ~T[17:00:00], "Etc/UTC"), "emp_001"),
        
        # Employee 1, Week 2  
        Factories.build_processed_time_entry("e1_w2_1",
          DateTime.new!(next_monday, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(next_monday, ~T[17:00:00], "Etc/UTC"), "emp_001"),
        
        # Employee 2, Week 1
        Factories.build_processed_time_entry("e2_w1_1",
          DateTime.new!(monday, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(monday, ~T[17:00:00], "Etc/UTC"), "emp_002")
      ]
      
      rule = ComplianceRules.weekly_aggregation_rule()
      aggregations = rule.action.(rule.pattern.(time_entries))
      
      assert length(aggregations) == 3 # 3 unique (employee, week) combinations
    ...
    test "filters out entries that already have aggregations" do
      ...
      time_entry = Factories.build_processed_time_entry("entry_1",
        DateTime.new!(monday, ~T[09:00:00], "Etc/UTC"),
        DateTime.new!(monday, ~T[17:00:00], "Etc/UTC"), "emp_001")
    ...
    test "handles entries spanning multiple weeks" do
      friday = ~D[2024-01-05]  # Friday of week 1
      saturday = ~D[2024-01-06] # Saturday of week 1
      monday = ~D[2024-01-08]   # Monday of week 2 (new week starts)
      
      time_entries = [
        # Friday entry (week 1)
        Factories.build_processed_time_entry("friday",
          DateTime.new!(friday, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(friday, ~T[17:00:00], "Etc/UTC"), "emp_001"),
        
        # Saturday entry (still week 1 - Sunday ends the week)
        Factories.build_processed_time_entry("saturday",
          DateTime.new!(saturday, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(saturday, ~T[17:00:00], "Etc/UTC"), "emp_001"),
        
        # Monday entry (week 2)
        Factories.build_processed_time_entry("monday",
          DateTime.new!(monday, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(monday, ~T[17:00:00], "Etc/UTC"), "emp_001")
      ]
  ...
  describe "weekly compliance rule" do
    ...
    test "filters out already checked aggregations" do
      monday = ~D[2024-01-01]
      weekly_aggregation = Factories.build_weekly_hours("emp_001", monday, 50.0, ["entry_1"])
      existing_result = Factories.build_compliance_result("emp_001", monday, :non_compliant, 48.0, 50.0)
    ...
    test "processes multiple employees and weeks" do
      ...
      aggregations = [
        Factories.build_weekly_hours("emp_001", monday, 45.0, ["e1_1"]),      # compliant
        Factories.build_weekly_hours("emp_001", next_monday, 55.0, ["e1_2"]), # non-compliant
        Factories.build_weekly_hours("emp_002", monday, 30.0, ["e2_1"]),      # compliant
        Factories.build_weekly_hours("emp_002", next_monday, 60.0, ["e2_2"])  # non-compliant
      ]
      ...
      # Count violations
      violations = Enum.count(compliance_results, fn {:compliance_result, _, %{status: status}} ->
        status == :non_compliant
      end)
      assert violations == 2
    end
  ...
  describe "process_compliance_check/2" do
    test "processes complete compliance workflow" do
      ...
      time_entries = [
        Factories.build_processed_time_entry("entry_1",
          DateTime.new!(monday, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(monday, ~T[21:00:00], "Etc/UTC"), "emp_001"), # 12 hours
        Factories.build_processed_time_entry("entry_2",
          DateTime.new!(Date.add(monday, 1), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 1), ~T[21:00:00], "Etc/UTC"), "emp_001"), # 12 hours
        Factories.build_processed_time_entry("entry_3",
          DateTime.new!(Date.add(monday, 2), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 2), ~T[21:00:00], "Etc/UTC"), "emp_001"), # 12 hours
        Factories.build_processed_time_entry("entry_4",
          DateTime.new!(Date.add(monday, 3), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 3), ~T[21:00:00], "Etc/UTC"), "emp_001"), # 12 hours
        Factories.build_processed_time_entry("entry_5",
          DateTime.new!(Date.add(monday, 4), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 4), ~T[15:00:00], "Etc/UTC"), "emp_001")  # 6 hours
      ...
      assert {:compliance_result, _, %{status: :non_compliant, actual_value: 54.0}} = compliance_result
    ...
    test "handles multiple employees with mixed compliance" do
      ...
      emp1_entries = [
        Factories.build_processed_time_entry("e1_1",
          DateTime.new!(monday, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(monday, ~T[17:00:00], "Etc/UTC"), "emp_001"), # 8 hours
        Factories.build_processed_time_entry("e1_2",
          DateTime.new!(Date.add(monday, 1), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 1), ~T[17:00:00], "Etc/UTC"), "emp_001"), # 8 hours
        Factories.build_processed_time_entry("e1_3",
          DateTime.new!(Date.add(monday, 2), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 2), ~T[17:00:00], "Etc/UTC"), "emp_001"), # 8 hours
        Factories.build_processed_time_entry("e1_4",
          DateTime.new!(Date.add(monday, 3), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 3), ~T[17:00:00], "Etc/UTC"), "emp_001"), # 8 hours
        Factories.build_processed_time_entry("e1_5",
          DateTime.new!(Date.add(monday, 4), ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 4), ~T[17:00:00], "Etc/UTC"), "emp_001")  # 8 hours
      ]
      
      # Employee 2: Non-compliant (60 hours)
      emp2_entries = [
        Factories.build_processed_time_entry("e2_1",
          DateTime.new!(monday, ~T[08:00:00], "Etc/UTC"),
          DateTime.new!(monday, ~T[20:00:00], "Etc/UTC"), "emp_002"), # 12 hours
        Factories.build_processed_time_entry("e2_2",
          DateTime.new!(Date.add(monday, 1), ~T[08:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 1), ~T[20:00:00], "Etc/UTC"), "emp_002"), # 12 hours
        Factories.build_processed_time_entry("e2_3",
          DateTime.new!(Date.add(monday, 2), ~T[08:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 2), ~T[20:00:00], "Etc/UTC"), "emp_002"), # 12 hours
        Factories.build_processed_time_entry("e2_4",
          DateTime.new!(Date.add(monday, 3), ~T[08:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 3), ~T[20:00:00], "Etc/UTC"), "emp_002"), # 12 hours
        Factories.build_processed_time_entry("e2_5",
          DateTime.new!(Date.add(monday, 4), ~T[08:00:00], "Etc/UTC"),
          DateTime.new!(Date.add(monday, 4), ~T[20:00:00], "Etc/UTC"), "emp_002")  # 12 hours
      ]
    ...
    test "uses default threshold when no rule spec provided" do
      ...
      time_entries = [
        Factories.build_processed_time_entry("entry_1",
          DateTime.new!(monday, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(monday, ~T[19:00:00], "Etc/UTC"), "emp_001") # 10 hours per day
      ]
      # Replicate for 5 days = 50 hours total
      all_entries = Enum.flat_map(0..4, fn day ->
        date = Date.add(monday, day)
        [Factories.build_processed_time_entry("entry_#{day}",
          DateTime.new!(date, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(date, ~T[19:00:00], "Etc/UTC"), "emp_001")]
      end)
      ...
      assert {:compliance_result, _, %{status: :non_compliant, threshold: 48.0}} = compliance_result
    end
  end
  ...
  describe "week boundary calculations" do
    test "correctly identifies Monday as week start" do
      test_dates = [
        {~D[2024-01-01], 1}, # Monday
        {~D[2024-01-02], 2}, # Tuesday  
        {~D[2024-01-07], 7}, # Sunday
        {~D[2024-01-08], 1}  # Monday (next week)
      ]
      
      Enum.each(test_dates, fn {date, expected_day} ->
        actual_day = Date.day_of_week(date)
        assert actual_day == expected_day, "Date #{date} should be day #{expected_day}, got #{actual_day}"
      end)
    end

    test "week_start_date returns correct Monday" do
      test_cases = [
        {~D[2024-01-01], ~D[2024-01-01]}, # Monday -> Monday
        {~D[2024-01-03], ~D[2024-01-01]}, # Wednesday -> Previous Monday
        {~D[2024-01-07], ~D[2024-01-01]}, # Sunday -> Previous Monday
        {~D[2024-01-08], ~D[2024-01-08]}  # Monday -> Monday
      ]
    ...
    test "week_dates returns correct Monday-Sunday sequence" do
      ...
      expected_dates = [
        ~D[2024-01-01], # Monday
        ~D[2024-01-02], # Tuesday
        ~D[2024-01-03], # Wednesday
        ~D[2024-01-04], # Thursday
        ~D[2024-01-05], # Friday
        ~D[2024-01-06], # Saturday
        ~D[2024-01-07]  # Sunday
      ]
    ...
    test "validates entries across year boundary" do
      ...
      december_monday = ~D[2023-12-25] # Monday before New Year
      
      time_entries = ComplianceTestHelpers.create_cross_week_entries("emp_001", ~D[2023-12-29]) # Friday
      ...
      assert {"emp_001", ~D[2024-01-01]} in keys # Next Monday (New Year)
    end

    test "handles leap year February correctly" do
      # Test February 29, 2024 (leap year)
      leap_day = ~D[2024-02-29] # Thursday
  ...
  describe "compliance analysis and reporting" do
    test "finds violations within date range" do
      ...
      compliance_results = [
        ...
        Factories.build_compliance_result("emp_001", Date.add(base_monday, 7), :compliant, 48.0, 40.0),
        Factories.build_compliance_result("emp_001", Date.add(base_monday, 14), :non_compliant, 48.0, 60.0),
        Factories.build_compliance_result("emp_002", base_monday, :non_compliant, 48.0, 50.0)
      ]
      
      # Find violations in first two weeks
      violations = ComplianceRules.find_violations_in_range(
        compliance_results, 
        base_monday, 
        Date.add(base_monday, 10)
      )
      
      assert length(violations) == 2 # Two violations in range
    end
    ...
    test "groups compliance results by employee" do
      ...
      compliance_results = [
        ...
        Factories.build_compliance_result("emp_001", Date.add(base_monday, 7), :non_compliant, 48.0, 55.0),
    ...
    test "calculates employee compliance statistics" do
      ...
      compliance_results = [
        Factories.build_compliance_result("emp_001", base_monday, :compliant, 48.0, 40.0),
        Factories.build_compliance_result("emp_001", Date.add(base_monday, 7), :non_compliant, 48.0, 55.0),
        Factories.build_compliance_result("emp_001", Date.add(base_monday, 14), :compliant, 48.0, 35.0),
        Factories.build_compliance_result("emp_001", Date.add(base_monday, 21), :non_compliant, 48.0, 52.0)
      ]
  ...
  describe "edge cases and error handling" do
    ...
    test "handles exact threshold boundary" do
      ...
      time_entries = Enum.map(0..5, fn day ->
        date = Date.add(monday, day)
        Factories.build_processed_time_entry("entry_#{day}",
          DateTime.new!(date, ~T[09:00:00], "Etc/UTC"),
          DateTime.new!(date, ~T[17:00:00], "Etc/UTC"), "emp_001")
      end)
      ...
      assert %{compliance_results: [compliance_result]} = result
      assert {:compliance_result, _, %{status: :compliant, actual_value: 48.0}} = compliance_result
    end
  ...
  describe "performance" do
    test "efficiently processes large datasets" do
      ...
      time_entries = for emp_id <- 1..100, week <- 0..3, day <- 0..6 do
        base_monday = ~D[2024-01-01]
      ...
      assert summary.total_weeks_checked == 400 # 100 employees * 4 weeks
    end
  end
end